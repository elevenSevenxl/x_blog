import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as i,f as a}from"./app-343dbe81.js";const d={},l=a(`<blockquote><p><code>map</code>会返回一个新的数组，而<code>forEach</code>不会</p></blockquote><p>forEach 和 map 都是 JavaScript 中用于遍历数组的函数，但它们的用法和返回值有所不同。</p><h3 id="foreach" tabindex="-1"><a class="header-anchor" href="#foreach" aria-hidden="true">#</a> forEach</h3><ol><li>forEach 没有返回值，总是返回 <code>undefined</code>。</li><li>除非抛出异常，否则没有办法停止或中断 <code>forEach()</code> 循环。如果有这样的需求，则不应该使用 <code>forEach()</code> 方法。</li></ol><p>示例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const arr = [1, 2, 3, 4, 5];
let sum = 0
arr.forEach((element) =&gt; {
